...
report_sxw.report_sxw(
    'report.purchase.order.elico', 'purchase.order',
    'addons/l10n_cn_report_purchase/report/purchase_order.rml',
    parser=order)
report_sxw.report_sxw(
    'report.purchase.order.requisition.elico', 'purchase.order',
    'addons/l10n_cn_report_purchase/report/purchase_po_requisition.rml',
    parser=order)
