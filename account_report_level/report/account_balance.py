...
class account_balance(report_sxw.rml_parse, common_report_header):
    ...
    def lines(self, form, ids=[], done=None):#, level=1):
        def _process_child(accounts, disp_acc, parent):
                ...
                if account_rec['level'] < form['level']:
        ...
        if child_ids:
            ids = child_ids
        accounts = obj_account.read(self.cr, self.uid, ids, ['type','code','name','debit','credit','balance','parent_id','level','child_id','amount_currency'], ctx)
