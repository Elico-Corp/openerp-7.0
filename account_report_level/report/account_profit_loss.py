...
report_sxw.report_sxw('report.pl.account.horizontal.level', 'account.account',
    'addons/account_report_level/report/account_profit_horizontal.rml',parser=report_pl_account_horizontal, header='internal landscape')
