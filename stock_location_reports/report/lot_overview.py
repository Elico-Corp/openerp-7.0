...
report_sxw.report_sxw('report.lot.stock.overview2', 'stock.location', 'addons/stock_location_reports/report/lot_overview.rml', parser=lot_overview, header='internal')
